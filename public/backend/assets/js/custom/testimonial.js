...
$('.edit').on('click', function (e) {
    ...
    selector.find('input[name=designation]').val($(this).data('item').designation)
    selector.find('textarea[name=comment]').val($(this).data('item').comment)
    selector.find('input[name=star]').val($(this).data('item').star)
