                        ...
                        if ($data->status === 'success') {
                            ...
                            if ($latestVersion == $codeVersion && $codeVersion > $currentVersion) {
                                ...
                                foreach ($allMoveFilePath as $filePath => $type) {
                                    ...
                                    if ($type == 'file') {
                                        File::move($demoPath . DIRECTORY_SEPARATOR . $codeRootPath . DIRECTORY_SEPARATOR . $filePath, base_path($filePath));
                                    } else {
                                        File::moveDirectory($demoPath . DIRECTORY_SEPARATOR . $codeRootPath . DIRECTORY_SEPARATOR . $filePath, base_path($filePath), true);
                                    }
