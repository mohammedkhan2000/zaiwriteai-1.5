            ...
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12">
                    <div class="breadcrumb-text">
                        <a class="brand-logo" href="#"><img src="{{ getSettingImage('app_logo') }}" alt="logo"></a>
                    ...
                    <div class="progres-stype">
                        <form action="{{ route('process-update') }}" method="POST">
                            ...
                            @else
                                ...
                                <p class="me-2 mb-2"><span class="text-danger">*</span> Current version {{ getOption('current_version', '1.0') }} </p>
