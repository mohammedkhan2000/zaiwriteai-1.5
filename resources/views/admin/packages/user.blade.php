...
@section('content')
                ...
                <div class="page-content-wrapper bg-white p-30 radius-20">
                    ...
                    <div class="row">
                        <div class="billing-center-area bg-off-white theme-border radius-4 p-25">
                            <table id="allPackagesUserTable" class="table responsive theme-border p-20 ">
    ...
    <input type="hidden" id="packagesUserRoute" value="{{ route('admin.packages.user') }}">
@endsection
...
@push('script')
    ...
    <script src="{{ asset('backend/assets/js/custom/packages-user.js') }}"></script>
@endpush
