...
<link href="{{ asset('backend/assets/libs/jquery-ui/jquery-ui.min.css') }}" rel="stylesheet">
...
<link rel="stylesheet" href="{{ asset('backend/assets/libs/owl-carousel/owl.theme.default.min.css') }}">

<link rel="stylesheet" href="{{ asset('backend/assets/libs/venobox/venobox.min.css') }}">
...
<link href="{{ asset('backend/assets/css/extra-style.css') }}" rel="stylesheet">
