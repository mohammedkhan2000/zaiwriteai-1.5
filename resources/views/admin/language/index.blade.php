                    ...
                    <div class="modal-body">
                        ...
                        <div class="modal-inner-form-box">
                            ...
                            <div class="row">
                                ...
                                <div class="upload-profile-photo-box">
                                    <div class="profile-user position-relative d-inline-block">
                                        <img src="{{ asset('backend/assets/images/no-image.jpg') }}"
...
@push('script')
    ...
    <script src="{{ asset('backend/assets/js/pages/add-language-icon.init.js') }}"></script>
    <script src="{{ asset('backend/assets/js/custom/language.js') }}"></script>
@endpush
