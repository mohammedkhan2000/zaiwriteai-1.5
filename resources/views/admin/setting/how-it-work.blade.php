                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <div class="tbl-action-btns d-inline-flex">
                                                                            ...
                                                                            <form
                                                                                action="{{ route('admin.setting.how-it-work.destroy', [$howItWork->id]) }}"
                                                                                method="post"
    ...
    <div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="addModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form class="ajax" action="{{ route('admin.setting.how-it-work.store') }}" method="POST"
                        ...
                        <div class="modal-inner-form-box">
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-25">
                                    ...
                                    <textarea name="summery" class="form-control" placeholder="{{ __('Summary') }}"></textarea>
                                </div>
                                <div class="col-md-12 mb-25">
                                    <label
...
@push('script')
    ...
    <script src="{{ asset('backend/assets/js/custom/howitwork.js') }}"></script>
@endpush
