                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="property-details-right text-end">
                                                            <button type="button" class="theme-btn" id="add"
                                                                title="{{ __('Add Brand') }}">{{ __('Add Brand') }}</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                        ...
                                                        <tbody>
                                                            @foreach ($brands as $brand)
                                                                <tr>
                                                                    ...
                                                                    <td>{{ $brand->name }}</td>
                                                                    <td><img src="{{ $brand->image }}" class="rounded avatar-md tbl-user-image" alt=""></td>
                                                                    <td>
                                                                    ...
                                                                    <td>
                                                                        <div class="tbl-action-btns d-inline-flex">
                                                                            ...
                                                                            <a href="#"
                                                                                ...
                                                                                data-formid="delete_row_form_{{ $brand->id }}"
                                                                                title="Delete"><span class="iconify"
                                                                                    data-icon="ep:delete-filled"></span></a>
                                                                            <form
                                                                                action="{{ route('admin.setting.brand.destroy', [$brand->id]) }}"
                                                                                method="post"
                                                                                id="delete_row_form_{{ $brand->id }}">
                                                                                {{ method_field('DELETE') }}
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="addModalLabel">{{ __('Add Brand') }}</h4>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"><span
                            class="iconify" data-icon="akar-icons:cross"></span></button>
                </div>
                <form class="ajax" action="{{ route('admin.setting.brand.store') }}" method="POST"
...
@push('script')
    ...
    <script src="{{ asset('backend/assets/js/custom/status-name.js') }}"></script>
@endpush
