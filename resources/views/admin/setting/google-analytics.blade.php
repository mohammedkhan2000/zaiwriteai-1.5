                            ...
                            <div
                                ...
                                <div class="page-title-right">
                                    <ol class="breadcrumb mb-0">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">{{ __($pageTitle) }}
                                        </li>
                                    </ol>
                                </div>
                            </div>
                                                    ...
                                                    <div class="settings-inner-box-fields p-20 pb-0">
                                                        <div class="row">
                                                            <div class="col-md-12 mb-25">
                                                                ...
                                                                <select name="analytics_enable"
                                                                    class="form-select flex-shrink-0">
                                                                    <option value="1"
                                                                        {{ getOption('analytics_enable') == 1 ? 'selected' : '' }}>
                                                                        {{ __('Active') }}</option>
                                                                    <option value="0"
                                                                        {{ getOption('analytics_enable') != 1 ? 'selected' : '' }}>
                                                            ...
                                                            <div class="col-md-12 mb-25">
                                                                <label
                                                                    class="label-text-title color-heading font-medium mb-2">{{ __('Measurement ID') }}</label>
                                                                <input type="text" name="google_analytics_measurement_id"
                                                                    value="{{ getOption('google_analytics_measurement_id') }}"
                                                                    placeholder="{{ __('Measurement ID') }}" class="form-control">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
