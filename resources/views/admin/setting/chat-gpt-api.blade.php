                                                    ...
                                                    <div class="settings-inner-box-fields p-20 pb-0">
                                                        <div class="row">
                                                            <div class="col-md-12 mb-25">
                                                                <label
                                                                    class="label-text-title color-heading font-medium mb-2">{{ __('Api') }}</label>
                                                                <input type="text" name="chat_gpt_api"
                                                                    value="{{ getOption('chat_gpt_api') }}"
                                                                    placeholder="{{ __('Api') }}" class="form-control">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
