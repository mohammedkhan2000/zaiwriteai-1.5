                                                    ...
                                                    <table id="allDataTable"
                                                        ...
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th class="all">{{ __('Designation') }}</th>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <div class="tbl-action-btns d-inline-flex">
                                                                            ...
                                                                            <form
                                                                                action="{{ route('admin.setting.testimonials.destroy', [$testimonial->id]) }}"
                                                                                method="post"
    ...
    <div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="addModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form class="ajax" action="{{ route('admin.setting.testimonials.store') }}" method="POST"
...
@push('script')
    ...
    <script src="{{ asset('backend/assets/js/custom/testimonial.js') }}"></script>
@endpush
