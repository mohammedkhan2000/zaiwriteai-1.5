    ...
    <div class="main-content">
        <div class="page-content">
            <div class="container-fluid">
                ...
                <div class="page-content-wrapper bg-light p-30 radius-20">
                    <!-- start page title -->
                    <div class="row">
                        <div class="col-12">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div
                                                    ...
                                                    <div class="profile-user position-relative d-inline-block">
                                                        <img src="@if (auth()->user()->image) {{ auth()->user()->image }} @else {{ asset('assets/images/no-image.jpg') }} @endif"
...
@push('script')
    ...
    <script src="{{ asset('backend/assets/js/pages/default-profile-setting.init.js') }}"></script>
@endpush
