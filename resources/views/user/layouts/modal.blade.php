...
<div class="modal fade big-modal" id="choosePlanModal" tabindex="-1" aria-hidden="true">
    <input type="hidden" id="chooseAPanRoute" value="{{ route('user.get_plan_modal_data') }}">
    <input type="hidden" id="getCurrencyByGatewayRoute" value="{{ route('user.get.currency') }}">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="choose-plan-area">
                    <h2 class="choose-plan-area-title text-center">Choose A Plan</h2>
                    <div class="d-flex justify-content-center align-items-center pb-30">
                        <span class="mx-3">Monthly</span>
                        <div class="payment-subscription-switch form-check form-switch">
                            <input class="form-check-input" type="checkbox" value="1" id="monthly-yearly-button">
                            <label class="form-check-label" for="monthly-yearly-button"></label>
                        </div>
                        <span class="mx-3">Yearly</span>
                    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="payment-method-area">
                    <h2 class="text-center payment-method-area-title">Select Payment Method</h2>
                    ...
                    <div class="payment-method-wrap px-5">
                        ...
                        <div class="row">
                            <div class="col-md-12 text-center">
                                <button type="button" class="theme-btn me-2 mb-1 w-75" id="payBtn">{{ __("Pay Now") }}
