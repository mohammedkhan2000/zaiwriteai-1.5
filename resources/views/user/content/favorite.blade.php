                                        ...
                                        @foreach ($categories as $key => $category)
                                            <button
                                                ...
                                                <span
                                                    ...
                                                    <img class="" src="{{ asset('storage/' . $category->first()->category_icon) }}" alt=""/>

                                                </span>
                                                <span class="topic-nav-title flex-grow-1">{{ $category->first()->category_name }}</span>
                                            </button>
                                        @endforeach
                                    </div>
                                </div>
                                    ...
                                    <div class="tab-pane fade {{ $loop->first ? 'show active' : '' }}"
                                        ...
                                        <div class="topic-content-item-wrap row">
                                            @foreach ($category as $subCategory)
                                                <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-4 mb-25 template-block">
                                                    ...
                                                    <a href="{{ route('user.search', $subCategory->id) }}"
                                                        ...
                                                        <div class="topic-content-item-btns d-flex align-content-center justify-content-between">
                                                            <div
                                                                class="topic-content-item-icon d-inline-flex align-items-center justify-content-center radius-50">
                                                                <img class="iconify" src="{{ asset('storage/' . $subCategory->sub_category_icon) }}" alt=""/>
                                                            </div>
                                                            <span
                                                                class="favoriteTemplate status-btn status-btn-orange status-btn-sm favorite-btn cursor"
                                                                title="Favorite"><span class="iconify font-17"
                                                                    data-icon="ph:star"></span></span>
                                                        </div>
                                                        <h4 class="mt-15">{{ $subCategory->name }}</h4>
